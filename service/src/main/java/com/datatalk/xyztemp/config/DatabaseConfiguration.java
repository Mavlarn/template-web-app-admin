package com.datatalk.xyztemp.config;

import com.datatalk.xyztemp.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories({"com.datatalk.xyztemp.repository", "com.datatalk.xyztemp.weixin.repository"})
