...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "datatalk@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "datatalk API";

        private String description = "datatalk API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "datatalk";
