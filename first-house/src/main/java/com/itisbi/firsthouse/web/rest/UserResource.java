...
import com.itisbi.firsthouse.web.rest.dto.ManagedUserDTO;
import com.itisbi.firsthouse.web.rest.util.HeaderUtil;
import com.itisbi.firsthouse.web.rest.util.PaginationUtil;
    ...
    public ResponseEntity<ManagedUserDTO> updateUser(@RequestBody ManagedUserDTO managedUserDTO) throws URISyntaxException {
        ...
        return Optional.of(userRepository
            ...
            .map(user -> {
                ...
                user.setRealName(managedUserDTO.getRealName());
