...
//     return es.merge(s, gulp.src('scss/main.scss')
//         .pipe(wiredep({
//             exclude: [
//                 /angular-i18n/,  // localizations are loaded dynamically
//                 'lib/bootstrap/' // Exclude Bootstrap LESS as we use bootstrap-sass
//             ],
//             ignorePath: /\.\.\/www\/lib\// // remove ../webapp/bower_components/ from paths of injected sass files
//         }))
//         .pipe(gulp.dest('scss')));
// });
gulp.task('wiredep:app', function () {
